...
fun PermissionsScreen(onBack: () -> Unit) {
    ...
    Scaffold(
        ...
        Column(
            ...
            // حدود لا يستطيع التطبيق تجاوزها، لكن من حق المستخدم معرفتها.
            Text(
                stringResource(R.string.permissions_notes_title),
                style = MaterialTheme.typography.titleSmall,
                color = MaterialTheme.colorScheme.onSurfaceVariant,
            )
            Text(
                stringResource(R.string.permissions_dnd_note),
                style = MaterialTheme.typography.bodySmall,
                color = MaterialTheme.colorScheme.onSurfaceVariant,
            )
            Text(
                stringResource(R.string.permissions_oem_note),
                style = MaterialTheme.typography.bodySmall,
                color = MaterialTheme.colorScheme.onSurfaceVariant,
            )
