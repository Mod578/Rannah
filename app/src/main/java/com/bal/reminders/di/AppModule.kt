...
abstract class AppModule {
    ...
    companion object {
        ...
        @Provides
        @Singleton
        fun hijriAdjustment(settingsRepository: SettingsRepository): HijriAdjustmentProvider =
            HijriAdjustmentProvider { settingsRepository.settings.first().hijriAdjustmentDays }
    }
}
